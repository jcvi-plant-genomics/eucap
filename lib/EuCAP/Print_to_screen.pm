...
my $side_links   = "/opt/www/medicago/cgi-bin/medicago-v35/medicago_links.txt";
my $gbrowsedb    = "medicago";
my $blastdb      = "mtbe";
my $site         = '<em>M. truncatula</em>';
my $project_name = '<table><tbody><tr>
<td><img src="/medicago-v35/include/images/mtr_leaf.png" width=50px /></td>
<td style="color: white; ">&nbsp;Medicago truncatula v3.5 Release</td>
</tr></tbody></table>';

my $zone;
if    ($ENV{SERVER_NAME}  =~ /dev/) { $zone = "-dev"; }
elsif ($ENV{SERVER_NAME} =~ /test/) { $zone = "-test"; }
else                                { $zone = ""; }
...
my $home_page = '/cgi-bin/medicago-v35/overview.cgi';

my $jcvi_template = $bootstrap_template;
my $title         = 'Medicago truncatula v3.5 Release :: Community Annotation';
...
<table cellpadding="10px" cellspacing="10px">
    <tr>
        <td><a href="http://www.nsf.gov/" target="_blank"><IMG src="/medicago-v35/include/images/nsf.jpg" border=0 width=50 height=50></a></td>
        <td>
